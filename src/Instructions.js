            ...
            <div className="step">
              ...
              <div className="step-content">
                ...
                <ol>
                  ...
                  <li>Отправьте команду /start в группе</li>
                  <li>Скопируйте ID группы из ответа бота</li>
        ...
        <section className="instruction-section">
          ...
          <div className="faq-container">
            <div className="faq-item">
              <h3>Как изменить настройки фильтрации?</h3>
              <p>Перейдите в раздел "Редактировать сайт" и настройте параметры в блоке "Настройки фильтрации".</p>
            </div>
